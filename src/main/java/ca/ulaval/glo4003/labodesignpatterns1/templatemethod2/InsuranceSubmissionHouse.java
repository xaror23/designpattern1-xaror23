...
public class InsuranceSubmissionHouse extends InsuranceSubmission{
  ...
  public InsuranceSubmissionHouse(String address,
                                String name,
                                String phoneNumber,
                                String email,
                                String type,
  ...
  private boolean isCoveragesValid() {
    List<String> filteredCoverages =
        coverages.stream()
            .filter(coverage -> HOME_COVERAGES.contains(coverage))
  ...
  private boolean isBuildDateValid() {
    return buildDate.isBefore(LocalDate.now());
  }
